class MapChart {
    ...
    render() {
        ...
        const minimumValue = d3.min(this.data, d => d[totalFieldName]);
        const maximumValue = d3.max(this.data, d => d[totalFieldName]);
        const ramp = d3
            .scaleLinear()
        ...
        this.forLegend(minimumValue, maximumValue);
    }

    forLegend(minimumValue, maximumValue) {
